...
JRESULT TJpg_Decoder::drawJpgFromStream(int32_t x, int32_t y, const char* _url) {
  JDEC jdec;
...
JRESULT TJpg_Decoder::getJpgSizeFromStream(uint16_t *w, uint16_t *h, const char *_url){
