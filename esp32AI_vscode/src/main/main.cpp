...
// 定义麦克风引脚
#define PIN_I2S_BCLK 1  // 时钟线，对应INMP441的SCK
#define PIN_I2S_LRC  2  // 声道选择线，对应INMP441的WS，由主机发送给从机，WS低电平时，从机发送左声道数据，高电平时发送右声道数据
#define PIN_I2S_DIN 14  // 数据线，对应INMP441的SD
